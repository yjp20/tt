...
<div id="comments" class="comments-area section">
	<div class="content">
		<?php if ( have_comments() ) : ?>
			<div class="header">
				<h2 class="section-label is-3"><?php esc_html_e('Comments', 'bulmapress'); ?></h2>
				<p class="subtitle">
		...
		<?php $comment_args = array(
			'comment_field' => '<div class="columns is-multiline"><div class="column '. (is_user_logged_in() ? 'is-12' : 'is-6') .'"><label class="label" for="comment">' . __( 'Your comment' ) . '</label>' . '<p class="control">' . '<textarea class="textarea" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea>' . '</p></div>',
